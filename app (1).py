...
st.markdown("---")
st.markdown(
    ":red[**ATENÇÃO**, para munícipios super populosos, recomendamos cautela.Partir imediatamente para próximos passos contatando a VITÁLIS, pois a métrica leva em consideração consumo em R$, número de habitantes e porte do município.]"
)
